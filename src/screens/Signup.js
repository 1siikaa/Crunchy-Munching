...
export default function Signup() {
  ...
  const handleClick = async (e) => {
    ...
    const response = await fetch("https://lambent-tulumba-f67bb3.netlify.app/getlocation", {
      method: 'POST',
      headers: {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch("https://lambent-tulumba-f67bb3.netlify.app/createuser", {
      // credentials: 'include',
